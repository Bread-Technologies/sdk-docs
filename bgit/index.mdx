...
<CardGroup cols={2}>
  ...
  <Card title="Workflows Guide" icon="diagram-project" href="/bgit/guides/workflows">
    Learn common patterns and workflows
  </Card>
  <Card title="Error Handling" icon="triangle-exclamation" href="/sdk/guides/error-handling">
    Handle errors gracefully
  </Card>
  <Card title="Client Configuration" icon="gears" href="/sdk/guides/client-configuration">
