...
Baking (also known as "prompt baking") is a technique that allows you to convert prompts into weight updates in a language model. It's a way to "bake in" prompts so that the AI inherently knows them without needing them at inference time.
...
<Steps>
  <Step title="1. Stim (Stimuli Generation)">
    ...
    **Purpose**: Predict and generate all the inputs a prompted language model would encounter while responding based on a given prompt.
...
<Steps>
  ...
  <Step title="Configure Target">
    ...
    client.targets.set(
        ...
        template="default",
        overrides={
            "generators": [{"type": "hardcoded", "questions": ["..."]}],
...
<CardGroup cols={2}>
  <Card title="✓ Good Use Cases" icon="circle-check">
    ...
    - Role or personality traits
    - Domain-specific knowledge
    - Reducing inference costs
    - Eliminating repeated system prompts
  </Card>
  <Card title="✗ Not Ideal For" icon="circle-xmark">
    - Frequently changing requirements
    - Dynamic, user-specific instructions
    - One-off tasks
    - Situations requiring prompt flexibility
  </Card>
</CardGroup>
