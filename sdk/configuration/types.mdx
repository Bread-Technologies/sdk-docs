...
# Oneshot QS
{
    ...
    "numq": int,
    "temperature": float,
    "template_path": str | None,  # Optional: path normalized to /templates/{template_name}
    "template_content": str | None  # Optional: template file content
}
...
interface OneshotGenerator {
  ...
  numq: number;
  temperature: number;
  template_path?: string | null;  // Optional: path normalized to /templates/{template_name}
  template_content?: string | null;  // Optional: template file content
}
