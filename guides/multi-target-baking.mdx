...
description: "Bake entire RAG knowledge bases into models. Information the AI just knows without any retrieval."
---

Multi-target baking lets you bake entire knowledge bases into a single model. Each piece of knowledge (a document, fact, procedure) becomes a [target](/understanding-baking#key-terminology), and you control how much each piece influences the final model through weighted datasets.
...
<Steps>
  ...
  <Step title="Create iPhone Support Target">
    ...
    client.targets.stim.run("iphone_support", "apple_support")
    client.targets.rollout.run("iphone_support", "apple_support")
    ```
  </Step>
  ...
  <Step title="Create Mac Support Target">
    ...
    client.targets.stim.run("mac_support", "apple_support")
    client.targets.rollout.run("mac_support", "apple_support")
    ```
  </Step>
  ...
  <Step title="Create AirPods Support Target">
    ...
    client.targets.stim.run("airpods_support", "apple_support")
    client.targets.rollout.run("airpods_support", "apple_support")
    ```
  ...
  <Step title="Combine Targets & Configure Bake">
    Combine all targets & specify bake config (in this example we set equal weightage):
    
    ```python
    bake = client.bakes.set(
        bake_name="apple_support_bot",
        repo_name="apple_support",
        template="default",
        overrides={
            "datasets": [
...
**The model already "knows" iPhone troubleshooting** - it's baked into the weights, not retrieved from a database.
...
- Target 1: "Product Overview" (30%)
- Target 2: "Feature Documentation" (25%)
- Target 3: "API Reference" (20%)
- Target 4: "Troubleshooting" (15%)
- Target 5: "FAQs" (10%)
...
- Target 1: "HR Policies" (35%)
- Target 2: "Code of Conduct" (25%)
- Target 3: "Benefits Information" (20%)
- Target 4: "Onboarding Procedures" (20%)

**Result:** HR assistant that knows all policies without searching documents.

### Bake Educational Content
Create subject-matter expert models:
- Target 1: "Biology Chapter 1: Cells" (20%)
- Target 2: "Biology Chapter 2: Genetics" (20%)
- Target 3: "Biology Chapter 3: Evolution" (20%)
- Target 4: "Biology Chapter 4: Ecosystems" (20%)
- Target 5: "Biology Chapter 5: Anatomy" (20%)

**Result:** Tutoring model with textbook knowledge baked in.

### Bake Legal Knowledge Base
Build specialized legal assistants:
- Target 1: "Contract Law Basics" (40%)
- Target 2: "Intellectual Property Guide" (30%)
- Target 3: "Employment Law" (30%)
