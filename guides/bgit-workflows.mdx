...
<div style={{display: 'flex', alignItems: 'center', gap: '12px', overflowX: 'auto', padding: '20px 0', flexWrap: 'wrap', justifyContent: 'center'}}>
  <div style={{flex: '0 0 auto', textAlign: 'center', padding: '20px 24px', borderRadius: '8px', background: 'transparent', border: '2px solid #F97316', minWidth: '140px'}}>
    ...
    <div style={{fontSize: '13px', opacity: 0.7}}>`your-model.yml`</div>
  </div>
...
### `your-model.yml`: Your Control Panel
...
<Steps>
  <Step title="Edit Configuration">
    Make changes to `your-model.yml` to specify your next baking operation:
    - Modify prompts
  ...
  <Step title="Repeat">
    Continue iterating:
    - Make more changes to `your-model.yml`
...
<Steps>
  <Step title="Create Experiment Branches">
    ...
    vim your-model.yml  # Edit for formal tone
    ...
    vim your-model.yml  # Edit for casual tone
  ...
  <Step title="Pick the Winner">
    ...
    git checkout experiment/casual-tone -- your-model.yml .bread recipe.yml
...
git diff main..experiment/formal-tone your-model.yml
...
<CardGroup cols={2}>
  <Card
    ...
    icon="file-code"
    href="/guides/bgit-yaml-reference"
  >
  ...
  >
    SDK documentation for advanced users
  </Card>
  <Card
