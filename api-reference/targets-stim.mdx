...
Stimulus (stim) generation creates questions, tasks, or prompts based on the target's generator configuration. Stim jobs execute asynchronously and their output is used as input for rollout jobs.
...
**Prerequisites**:
- Target must have stim configuration (generators, u, v)
