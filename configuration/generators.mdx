...
<ParamField path="model" type="string">
  Model name (Only Anthropic models supported e.g., `"claude-3-5-sonnet-20241022"`, `"claude-4-5-sonnet"`)
</ParamField>
...
It is advantageous to use a combination of generators to create a complete dataset for a bake. Use multiple generators for a target:
