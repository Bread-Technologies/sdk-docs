...
```python
from bread.types import MessageParam
...
```python
from bread.types import TargetConfigBaseParam
...
```python
from bread.types import BakeConfigBaseParam
...
```python
from bread import Bread
from bread.types import RepoResponse, PromptResponse
...
from bread import Bread
from bread.types import MessageParam, PromptResponse
...
<AccordionGroup>
  ...
  <Accordion title="Import Types Explicitly" icon="file-import">
    Import types from `bread.types` for better autocomplete
  </Accordion>
